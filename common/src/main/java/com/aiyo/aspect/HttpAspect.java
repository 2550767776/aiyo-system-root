package com.aiyo.aspect;

import com.aiyo.common.annotation.RequiredPermission;
import com.aiyo.common.constant.CommonConstant;
import com.aiyo.common.result.R;
import com.aiyo.common.utils.JwtUtil;
import com.aiyo.common.utils.ReBeanUtils;
import com.aiyo.entity.SysDictionary;
import com.aiyo.entity.SysLog;
import com.aiyo.entity.SysUser;
import com.aiyo.entity.SysUserRole;
import com.aiyo.service.ISysLogService;
import com.aiyo.vo.UserVo;
...
public class HttpAspect {
     ...
     * 定义公共方法，定义aop的切入点
     */
    @Pointcut("execution(public * com.aiyo.controller..*(..)) || execution(public * com.aiyo.common.base..*(..))")
    public void point() {
    }
